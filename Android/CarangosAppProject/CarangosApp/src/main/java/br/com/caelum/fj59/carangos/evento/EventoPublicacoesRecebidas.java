...
/**
 * Created by android6232 on 20/07/16.
 */
public class EventoPublicacoesRecebidas extends BroadcastReceiver {
    ...
    public static EventoPublicacoesRecebidas
             registraObservador(BuscaMaisPublicacoesDelegate delegate) {
    ...
    public void desregistra(CarangosApplicantion applicantion) {

        LocalBroadcastManager.getInstance(applicantion).unregisterReceiver(this);
