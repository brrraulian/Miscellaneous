        ...
        if (item != null) {
            ...
            with(item) {
                ...
                if (owner != null) {
                    ...
                    if (!owner!!.avatar_url!!.isNullOrEmpty())
                        com.squareup.picasso.Picasso.with(context)
                                ...
                                .placeholder(com.ricardonuma.desafioandroid.R.drawable.ic_alert_error)
                                .resize(360, 360)
                                .centerCrop()
                ...
                holder.mConstraintLayout.setOnClickListener(android.view.View.OnClickListener {
                    val intent = android.content.Intent(context, com.ricardonuma.desafioandroid.pullRequest.PullRequestActivity::class.java)
                    intent.putExtra(com.ricardonuma.desafioandroid.pullRequest.PullRequestActivity.EXTRA_ID_REPOSITORY, item.id)
                    intent.putExtra(com.ricardonuma.desafioandroid.pullRequest.PullRequestActivity.EXTRA_LOGIN, item.owner!!.login)
                    intent.putExtra(com.ricardonuma.desafioandroid.pullRequest.PullRequestActivity.EXTRA_NAME, item.name)
