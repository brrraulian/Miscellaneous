<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="New.aspx.cs" Inherits="Demo.New" %>
                                ...
                                <center>
                                    <table class="tableNewButton">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="button_back" CssClass="button" runat="server" Text="Back" OnClientClick="location.href = 'Default.aspx'; return false;" />
                                            </td>
                                        </tr>
                                    </table>
                                </center>
