...
function Validar() {
    ...
    //var temp;
    //for (var i = 0; i < txt_qtdeMerc.value.length; i++) {
    //    temp = txt_qtdeMerc.value.substring(i, i + 1);
    //    if (digits.indexOf(temp) == -1) {
    //        lbl_erro.innerHTML += "- Informe a quantidade no formato correto\n";
    //        txt_qtdeMerc.focus();
    //        return false;
    //    }
    //}
